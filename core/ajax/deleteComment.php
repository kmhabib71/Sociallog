...
if(isset($_POST['deleteComment']) && !empty($_POST['deleteComment'])){
	...
	$getFromU->delete('comments', array('commentID' => $commentID));
...
$getFromT->editReply($editReplyComment, $tweetId, $editReplId, $editReplData);
...
$getFromT->editComment($editComment, $tweetId, $editCommlData);
