...
if(isset($_POST['commentIDD']) && !empty($_POST['commentIDD'])){
    ...
    $getFromP->commentUnReactExist($page_id,$user_id, $tweet_id, $get_id, $comment_id);
  $reactExist=$getFromP->CommentReactExistingCheck($page_id, $tweet_id, $user_id, $comment_id); 
    $rex = COUNT($reactExist);
  $smileI=$getFromP->smileCountCheck($page_id, $tweet_id, $user_id, $react_type); 
$sl = COUNT($reactExist); 
...
// if($rex >0 ){
    ...
    $getFromP->addCommentReact($page_id,$user_id, $tweet_id, $get_id,$react_type,$comment_id);
// }
...
if(isset($_POST['replyIdD']) && !empty($_POST['replyIdD'])){
    ...
    $page_id = $_POST['page_id'];
    $getFromP->reactUnReactExist($page_id, $user_id, $tweet_id, $get_id, $comment_id, $replyIdD);
  $reactExis=$getFromP->replyReactExistingCheck($page_id, $tweet_id, $user_id, $comment_id, $replyIdD); 
    $rex = COUNT($reactExis);
...
// if($rex >0 ){
    ...
    $getFromP->addReplyReact($page_id, $user_id, $tweet_id, $get_id,$react_type,$comment_id, $replyIdD);
// }
